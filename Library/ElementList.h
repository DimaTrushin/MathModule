...
template<int... TElements>
using MakeElementList = typename MakeElementListImpl<TElements...>::Result;
...
template<class TElementSeq>
using Seq2List = typename Seq2ListImpl<TElementSeq>::Result;
...
struct IsDecreasing<ElementList<THead, ElementList<THead2, TTail2>>> {
  static constexpr bool value = THead > THead2 &&
                                IsDecreasing<ElementList<THead2, TTail2>>::value ;
};
//--------------------------------------------------------------------------------
// Length
//--------------------------------------------------------------------------------
...
template<class TList, int TElement>
using Append = typename AppendImpl<TList, TElement>::Result;
...
template<class TList1, class TList2>
using Merge = typename MergeImpl<TList1, TList2>::Result;
...
template<class TList, int TElement>
using Erase = typename EraseImpl<TList, TElement>::Result;
...
template<class TList, int TElement>
using EraseAll = typename EraseAllImpl<TList, TElement>::Result;
...
template<class TList, int TToReplace, int TToReplaceWith>
using ReplaceAll = typename ReplaceAllImpl<TList, TToReplace, TToReplaceWith>::Result;
...
template<int TToReplace, class TTail, int TToReplaceWith>
struct ReplaceAllImpl<ElementList<TToReplace, TTail>, TToReplace, TToReplaceWith> {
  using Result = ElementList<TToReplaceWith, ReplaceAll<TTail, TToReplace, TToReplaceWith>>;
};

template<int THead, class TTail, int TToReplace, int TToReplaceWith>
struct ReplaceAllImpl<ElementList<THead, TTail>, TToReplace, TToReplaceWith> {
  using Result = ElementList<THead, ReplaceAll<TTail, TToReplace, TToReplaceWith>>;
};
//--------------------------------------------------------------------------------
} // EL
//--------------------------------------------------------------------------------
